...
local logs = "SEU WEBHOOK AQUI"

local kick_msg = "O QUE VOCÊ ESTÁ FAZENDO USANDO O DEV TOOLS?" --Mensagem de Aviso quando der o kick no usuário.
local discord_msg = '`Esse  Jogador tentou utilizar o DEV TOOLS`\n`e foi expulso`\n`ANTI NUI_DEVTOOLS`'
    ...
    local sendD = {
        {
            ...
            ["footer"] = {
                ["text"] = "© char nome[6] = "Steel"#4990"..os.date("%x %X %p")
            },
        }
    }
